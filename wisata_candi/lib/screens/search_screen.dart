...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      //TODO: 2. Buatkan appbr dengan judul pencarian candi
      appBar: AppBar(title: Text('Pencarian Candi'),),
      //TODO: 3. Buat body berupa coloum 
      body: Column(
        children: [
      //TODO: 4. Buat TextField pencarian sebagai anak dari coloum
      Padding(
      ...
      //TODO: 5. Buat listView hasil penacrian sebagai anak dari coloum
     Expanded(
